...
import { ChevronLeft, ChevronRight, Linkedin, Globe } from "lucide-react";
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto max-w-2xl text-muted-foreground">
            Learn from industry leaders and open source pioneers who are driving innovation forward
          </p>
        </div>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {speakers.map((speaker, index) => (
              ...
              >
                ...
                <p className="mb-4 text-sm text-muted-foreground">{speaker.expertise}</p>
